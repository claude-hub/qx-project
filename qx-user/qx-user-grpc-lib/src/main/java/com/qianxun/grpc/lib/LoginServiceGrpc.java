...
public final class LoginServiceGrpc {
  ...
  public static final String SERVICE_NAME = "lib.LoginService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.qianxun.grpc.lib.Login.LoginReq,
      com.qianxun.grpc.lib.Login.LoginRes> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = com.qianxun.grpc.lib.Login.LoginReq.class,
      responseType = com.qianxun.grpc.lib.Login.LoginRes.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.qianxun.grpc.lib.Login.LoginReq,
      com.qianxun.grpc.lib.Login.LoginRes> getLoginMethod() {
    io.grpc.MethodDescriptor<com.qianxun.grpc.lib.Login.LoginReq, com.qianxun.grpc.lib.Login.LoginRes> getLoginMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLoginMethod = LoginServiceGrpc.getLoginMethod) == null) {
          LoginServiceGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<com.qianxun.grpc.lib.Login.LoginReq, com.qianxun.grpc.lib.Login.LoginRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "lib.LoginService", "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qianxun.grpc.lib.Login.LoginReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qianxun.grpc.lib.Login.LoginRes.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(com.qianxun.grpc.lib.Login.LoginReq request,
        io.grpc.stub.StreamObserver<com.qianxun.grpc.lib.Login.LoginRes> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.qianxun.grpc.lib.Login.LoginReq,
                com.qianxun.grpc.lib.Login.LoginRes>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public com.qianxun.grpc.lib.Login.LoginRes login(com.qianxun.grpc.lib.Login.LoginReq request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.qianxun.grpc.lib.Login.LoginRes> login(
        com.qianxun.grpc.lib.Login.LoginReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.qianxun.grpc.lib.Login.LoginReq) request,
              (io.grpc.stub.StreamObserver<com.qianxun.grpc.lib.Login.LoginRes>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.qianxun.grpc.lib.Login.getDescriptor();
    }
