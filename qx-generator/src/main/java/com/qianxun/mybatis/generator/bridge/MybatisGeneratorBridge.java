package com.qianxun.mybatis.generator.bridge;

import com.qianxun.mybatis.generator.model.DatabaseConfig;
import com.qianxun.mybatis.generator.model.DbType;
import com.qianxun.mybatis.generator.model.GeneratorConfig;
import com.qianxun.mybatis.generator.plugins.DbRemarksCommentGenerator;
    ...
    public void generate() throws Exception {
        ...
        if (generatorConfig.isOffsetLimit()) {
            if (DbType.MySQL.name().equals(selectedDatabaseConfig.getDbType())
                ...
                pluginConfiguration.addProperty("type", "MySQLLimitPlugin");
                pluginConfiguration.setConfigurationType("MySQLLimitPlugin");
