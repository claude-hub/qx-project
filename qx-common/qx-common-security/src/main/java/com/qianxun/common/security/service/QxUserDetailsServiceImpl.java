package com.qianxun.common.security.service;
...
@Service
@AllArgsConstructor
public class QxUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		if (cache != null && cache.get(username) != null) {
			return (QxUser) cache.get(username).get();
		}
	...
	private UserDetails getUserDetails(R<UserInfo> result) {
		...
		// 构造security用户
		return new QxUser(user.getUserId(), user.getDeptId(), user.getUsername(), SecurityConstants.BCRYPT + user.getPassword(),
