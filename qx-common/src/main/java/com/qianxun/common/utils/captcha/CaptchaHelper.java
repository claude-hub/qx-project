package com.qianxun.common.utils.captcha;
...
public class CaptchaHelper {
    ...
    /*=============Config值===================*/
    private String seKey = "com.qianxun";       // 验证码加密密钥
    ...
    private void entry(HttpServletRequest request, HttpServletResponse response, String id) throws Exception {
        ...
        g.setColor(color);
        //设置字体
        InputStream ttfFile = CaptchaHelper.class.getResourceAsStream("/com/qianxun/captcha/captcha.ttf");
